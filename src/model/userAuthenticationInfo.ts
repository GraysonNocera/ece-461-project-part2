...
export const UserAuthenticationInfoSchema: mongoose.Schema<UserAuthenticationInfo> =
  new mongoose.Schema<UserAuthenticationInfo>({
    password: { type: String, required: true },
  });

export const UserAuthenticationInfoModel =
  mongoose.model<UserAuthenticationInfo>(
